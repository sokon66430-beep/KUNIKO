 ...
 * The recipe screen.
 *
 * Lives here rather than in a page because Master Data owns recipes now and
 * mounts this as a tab. `embedded` drops the page title — inside Master Data the
 * page already has one, and two headers stacked reads as a mistake.
 */
export default function RecipesManager({ embedded = false }: { embedded?: boolean } = {}) {
